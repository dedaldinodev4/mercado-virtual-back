...
discountRoutes.route('/')
  .post((request, response) => { return createDiscountFactory().handle(request, response) } )
...
discountRoutes.route('/:id')
  ...
  .put((request, response) => { return updateDiscountFactory().handle(request, response) } )
  .delete((request, response) => { return deleteDiscountFactory().handle(request, response) } )
