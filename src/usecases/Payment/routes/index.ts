...
paymentRoutes.route('/')
  .post(ensuredAuthenticated(), (request, response) => { return createPaymentFactory().handle(request, response) } )
...
paymentRoutes.route('/:id')
  ...
  .put(ensuredAuthenticated(), (request, response) => { return updatePaymentFactory().handle(request, response) } )
  .delete(ensuredAuthenticated(), (request, response) => { return deletePaymentFactory().handle(request, response) } )
