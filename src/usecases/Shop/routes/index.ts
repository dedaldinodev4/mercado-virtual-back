...
shopRoutes.route('/')
  .post((request, response) => { return createShopFactory().handle(request, response) } )
...
shopRoutes.route('/:id')
  ...
  .put((request, response) => { return updateShopFactory().handle(request, response) } )
  .delete((request, response) => { return deleteShopFactory().handle(request, response) } )
