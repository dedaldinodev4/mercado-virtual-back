...
export interface IProductDetail extends IBaseDTO {
...
export interface IProductDetailRequest  extends IProductDetailUpdateRequest {
  id_product: string;
}

export interface IProductDetailUpdateRequest  {
  processor?: string;
  screen?: string;
